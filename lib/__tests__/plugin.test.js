...
test('non toplevel, should not change', () => {
    // Given
    const { source, target } = given('nontoplevel');
...
test('embedded return, should change', () => {
    // Given
    const { source, target } = given('embedded-return');
...
test('embedded return with argument, should change', () => {
    // Given
    const { source, target } = given('embedded-return-arguments');
...
test('embedded return with argument, should change', () => {
    // Given
    const { source, target } = given('embedded-return-extra-statements');
...
test('const with destructure in param, should change', () => {
    // Given
    const { source, target } = given('destructure');
