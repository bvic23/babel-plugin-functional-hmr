...
function renderFunction(t, arrowFunction, isEmbeddedReturn) {
    ...
    const arrowBody = isEmbeddedReturn ? arrowFunction.body.body[0].argument : arrowFunction.body;
    const returnStatement = t.returnStatement(t.parenthesizedExpression(arrowBody));
    ...
    const arrowVisitor = function(state) {
        return function(path) {
            ...
            const isEmbeddedReturn =
                ...
                arrowBody.body[0].type === 'ReturnStatement' &&
                arrowBody.body[0].argument.type === 'JSXElement';
            ...
            const renderMethod = renderFunction(t, arrowFunction, isEmbeddedReturn);
