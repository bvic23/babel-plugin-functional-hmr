...
function renderFunction(t, arrowFunction) {
    const properties = arrowFunction.params[0].properties.map(function(prop) {
        return prop.key;
    });
    ...
    const renderBody = t.blockStatement([destructProps, returnStatement]);
...
module.exports = function({ Plugin, types: t }) {
    ...
    const arrowVisitor = function(state) {
        return function(path) {
            ...
            if (arrowFunction.params[0].type !== 'ObjectPattern') return;
